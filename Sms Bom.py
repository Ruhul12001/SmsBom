...
\033[1;92m[+] AUTHOR       :   MD. RUHUL AMIN
\x1b[1;92m[+] FACEBOOK     :   Md. Ruhul Amin (Hridoy)
\x1b[1;92m[+] GITHUB       :   Ruhul12001
\x1b[1;12m[+] TEAM         :   Cyber Security 
...
rp= 'Ruhul'
x = 'Ruhul0987'
if 'Ruhul'==user and 'Ruhul0987'==pas:
        Axak(g+"\n\n\t\t      LOGIN SUCCESSFUL  ")
        ...
        time.sleep(3)
        os.system('xdg-open https://www.facebook.com/Ruhul.Amin.0987')
...
\033[1;32m.| _ \| | | || || || | | || |     | _ )|   \  
\033[1;32m.|   /| |_| || __ || |_| || |__   | _ \| |) | 
\033[1;32m.|_|_\ \___/ |_||_| \___/ |____|  |___/|___/  
